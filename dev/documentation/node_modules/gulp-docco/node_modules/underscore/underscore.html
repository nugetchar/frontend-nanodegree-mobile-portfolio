...
for Closure Compiler “advanced” mode.</p>
    ...
    root._ = _;
        ...
        <li id="section-12">
            ...
            <div class="content"><div class='highlight'><pre>  _.VERSION = <span class="hljs-string">'1.5.2'</span>;</pre></div></div>
...
Aliased as <code>select</code>.</p>
    ...
    each(obj, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">value, index, list</span>) </span>{
      <span class="hljs-keyword">if</span> (iterator.call(context, value, index, list)) results.push(value);
    });
    <span class="hljs-keyword">return</span> results;
  };</pre></div></div>
...
containing specific <code>key:value</code> pairs.</p>
    ...
    <span class="hljs-keyword">if</span> (_.isEmpty(attrs)) <span class="hljs-keyword">return</span> first ? <span class="hljs-keyword">void</span> <span class="hljs-number">0</span> : [];
...
The internal <code>guard</code> argument allows it to work with <code>map</code>.</p>
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-built_in">arguments</span>.length &lt; <span class="hljs-number">2</span> || guard) {
    ...
    <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, value, context</span>) </span>{
      <span class="hljs-keyword">var</span> result = {};
      <span class="hljs-keyword">var</span> iterator = value == <span class="hljs-literal">null</span> ? _.identity : lookupIterator(value);
...
allows it to work with <code>_.map</code>.</p>
    ...
    <span class="hljs-keyword">return</span> (n == <span class="hljs-literal">null</span>) || guard ? array[<span class="hljs-number">0</span>] : slice.call(array, <span class="hljs-number">0</span>, n);
  };</pre></div></div>
...
<code>{leading: false}</code>. To disable execution on the trailing edge, ditto.</p>
    ...
    <span class="hljs-keyword">var</span> later = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
      previous = options.leading === <span class="hljs-literal">false</span> ? <span class="hljs-number">0</span> : <span class="hljs-keyword">new</span> <span class="hljs-built_in">Date</span>;
...
leading edge, instead of the trailing.</p>
    ...
    <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
      ...
      <span class="hljs-keyword">var</span> later = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">var</span> last = (<span class="hljs-keyword">new</span> <span class="hljs-built_in">Date</span>()) - timestamp;
