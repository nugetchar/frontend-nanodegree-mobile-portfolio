...
<span class="hljs-keyword">var</span> minifier = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./minifier'</span>);
...
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">opts</span>) </span>{
  <span class="hljs-keyword">return</span> minifier(opts, uglify);
};</pre></div></div>
