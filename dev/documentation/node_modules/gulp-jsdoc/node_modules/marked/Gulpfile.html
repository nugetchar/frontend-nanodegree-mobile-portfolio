...
<span class="hljs-keyword">var</span> preserveFirstComment = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">var</span> set = <span class="hljs-literal">false</span>;

  <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
     <span class="hljs-keyword">if</span> (set) <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
...
gulp.task(<span class="hljs-string">'uglify'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  gulp.src(<span class="hljs-string">'lib/marked.js'</span>)
    .pipe(uglify({preserveComments: preserveFirstComment()}))
    .pipe(concat(<span class="hljs-string">'marked.min.js'</span>))
    .pipe(gulp.dest(<span class="hljs-string">'.'</span>));
});

gulp.task(<span class="hljs-string">'default'</span>, [<span class="hljs-string">'uglify'</span>]);</pre></div></div>
