  ...
  <div id="container">
    ...
    <ul class="sections">
        ...
        <li id="section-1">
            ...
            <div class="content"><div class='highlight'><pre><span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">args, opts</span>) </span>{
    <span class="hljs-keyword">if</span> (!opts) opts = {};
    
    <span class="hljs-keyword">var</span> flags = { bools : {}, strings : {}, unknownFn: <span class="hljs-literal">null</span> };
    ...
    <span class="hljs-keyword">var</span> argv = { _ : [] };
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; args.length; i++) {
        ...
        <span class="hljs-keyword">if</span> (<span class="hljs-regexp">/^--.+=/</span>.test(arg)) {</pre></div></div>
...
<a href="http://stackoverflow.com/a/1068308/13216">http://stackoverflow.com/a/1068308/13216</a></p>

            </div>
            
            <div class="content"><div class='highlight'><pre>            <span class="hljs-keyword">var</span> m = arg.match(<span class="hljs-regexp">/^--([^=]+)=([\s\S]*)$/</span>);
