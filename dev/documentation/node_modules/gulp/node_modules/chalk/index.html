...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">Chalk</span>(<span class="hljs-params">options</span>) </span>{</pre></div></div>
        ...
        <li id="section-2">
            ...
            <div class="content"><div class='highlight'><pre>	<span class="hljs-keyword">this</span>.enabled = !options || options.enabled === <span class="hljs-literal">undefined</span> ? supportsColor : options.enabled;
}</pre></div></div>
        ...
        <li id="section-3">
            ...
            <div class="content"><div class='highlight'><pre><span class="hljs-keyword">if</span> (isSimpleWindowsTerm) {
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">build</span>(<span class="hljs-params">_styles</span>) </span>{
	...
	builder.enabled = <span class="hljs-keyword">this</span>.enabled;</pre></div></div>
...
no way to create a function with a different prototype.</p>
            ...
            <div class="content"><div class='highlight'><pre>	<span class="hljs-comment">/* eslint-disable no-proto */</span>
	builder.__proto__ = proto;

	<span class="hljs-keyword">return</span> builder;
}

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">applyStyle</span>(<span class="hljs-params"></span>) </span>{</pre></div></div>
	...
	<span class="hljs-keyword">if</span> (argsLen &gt; <span class="hljs-number">1</span>) {</pre></div></div>
        ...
        <li id="section-6">
            ...
            <div class="content"><div class='highlight'><pre>		<span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> a = <span class="hljs-number">1</span>; a &lt; argsLen; a++) {
	...
	<span class="hljs-keyword">var</span> i = nestedStyles.length;</pre></div></div>
...
see <a href="https://github.com/chalk/chalk/issues/58">https://github.com/chalk/chalk/issues/58</a>
If we’re on Windows and we’re dealing with a gray color, temporarily make ‘dim’ a noop.</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>	<span class="hljs-keyword">var</span> originalDim = ansiStyles.dim.open;
	...
	<span class="hljs-keyword">while</span> (i--) {
		<span class="hljs-keyword">var</span> code = ansiStyles[nestedStyles[i]];</pre></div></div>
...
will be colored, and the rest will simply be ‘plain’.</p>
            ...
            <div class="content"><div class='highlight'><pre>		str = code.open + str.replace(code.closeRe, code.open) + code.close;
	}</pre></div></div>
        ...
        <li id="section-9">
            ...
            <div class="content"><div class='highlight'><pre>	ansiStyles.dim.open = originalDim;
...
<span class="hljs-built_in">module</span>.exports.supportsColor = supportsColor;</pre></div></div>
