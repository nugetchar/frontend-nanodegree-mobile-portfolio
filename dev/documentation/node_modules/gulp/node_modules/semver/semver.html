...
<body>
  ...
  exports = <span class="hljs-built_in">module</span>.exports = SemVer;</pre></div></div>
        ...
        <li id="section-2">
            ...
            <div class="content"><div class='highlight'><pre><span class="hljs-comment">/* nomin */</span> <span class="hljs-keyword">var</span> debug;
<span class="hljs-comment">/* nomin */</span> <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> process === <span class="hljs-string">'object'</span> &amp;&amp;
    <span class="hljs-comment">/* nomin */</span> process.env &amp;&amp;
    <span class="hljs-comment">/* nomin */</span> process.env.NODE_DEBUG &amp;&amp;
    <span class="hljs-comment">/* nomin */</span> /\bsemver\b/i.test(process.env.NODE_DEBUG))
  <span class="hljs-comment">/* nomin */</span> debug = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-comment">/* nomin */</span> <span class="hljs-keyword">var</span> args = <span class="hljs-built_in">Array</span>.prototype.slice.call(<span class="hljs-built_in">arguments</span>, <span class="hljs-number">0</span>);
    <span class="hljs-comment">/* nomin */</span> args.unshift(<span class="hljs-string">'SEMVER'</span>);
    <span class="hljs-comment">/* nomin */</span> <span class="hljs-built_in">console</span>.log.apply(<span class="hljs-built_in">console</span>, args);
    <span class="hljs-comment">/* nomin */</span> };
<span class="hljs-comment">/* nomin */</span> <span class="hljs-keyword">else</span>
  <span class="hljs-comment">/* nomin */</span> debug = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{};</pre></div></div>
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">SemVer</span>(<span class="hljs-params">version, loose</span>) </span>{
  ...
  debug(<span class="hljs-string">'SemVer'</span>, version, loose);
...
SemVer.prototype.compare = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">other</span>) </span>{
  debug(<span class="hljs-string">'SemVer.compare'</span>, <span class="hljs-keyword">this</span>.version, <span class="hljs-keyword">this</span>.loose, other);
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">Comparator</span>(<span class="hljs-params">comp, loose</span>) </span>{
  ...
  debug(<span class="hljs-string">'comparator'</span>, comp, loose);
  <span class="hljs-keyword">this</span>.loose = loose;
...
Comparator.prototype.test = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">version</span>) </span>{
  debug(<span class="hljs-string">'Comparator.test'</span>, version, <span class="hljs-keyword">this</span>.loose);
...
Range.prototype.parseRange = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">range</span>) </span>{
  ...
  range = range.trim();
  debug(<span class="hljs-string">'range'</span>, range, loose);</pre></div></div>
  ...
  debug(<span class="hljs-string">'hyphen replace'</span>, range);</pre></div></div>
  ...
  debug(<span class="hljs-string">'comparator trim'</span>, range, re[COMPARATORTRIM]);</pre></div></div>
...
turn into a set of JUST comparators.</p>
  ...
  debug(<span class="hljs-string">'comp'</span>, comp);
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">replaceCaret</span>(<span class="hljs-params">comp, loose</span>) </span>{
  debug(<span class="hljs-string">'caret'</span>, comp, loose);
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">replaceXRanges</span>(<span class="hljs-params">comp, loose</span>) </span>{
  debug(<span class="hljs-string">'replaceXRanges'</span>, comp, loose);
...
and ‘’ means “any version”, just remove the </em>s entirely.</p>
  ...
  debug(<span class="hljs-string">'replaceStars'</span>, comp, loose);</pre></div></div>
