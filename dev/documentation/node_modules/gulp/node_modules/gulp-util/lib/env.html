...
<span class="hljs-keyword">var</span> argv = parseArgs(process.argv.slice(<span class="hljs-number">2</span>));

<span class="hljs-built_in">module</span>.exports = argv;</pre></div></div>
